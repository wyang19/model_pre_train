...
class Config(object):
    def __init__(self):
        # -----------ARGS---------------------
        # 原始数据路径
        self.source_data_path = '/home/wyang/data/ccf_emotion/'
        # 预训练数据路径
        self.pretrain_train_path = "/home/wyang/data/ccf_emotion/256_corpus.txt"
        # 模型保存路径
        ...
        self.pretrain_model_path = '/home/wyang/pretrained_model/Torch_model/pre_model_nezha_base/'
